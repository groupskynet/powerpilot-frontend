	...
	return (
		<div className="sidebar bg-gray-50 w-68 flex-none flex flex-col  overflow-y-hiden">
			<div className="sidebar__logo flex justify-center mt-5">
				<img className="w-4/5 max-w-xs" src={logo} alt="logo DAR" />
			</div>
			<div className="pt-12  flex flex-col items-start flex-grow overflow-y-auto">
				<SidebarDropdown
					...
					<SidebarLink link={"password"} title="Cambiar Contraseña" Linkactive={false}>
				...
				<SidebarDropdown
					...
					<SidebarLink link={"gestion"} title="Máquinas" linkactive={false}>
						<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z" />
							<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0" />
						</svg>
					</SidebarLink>
					<SidebarLink link={"accesorios"} title="Accesorios" linkactive={false}>
						<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
						</svg>
					</SidebarLink>
					<SidebarLink link={"operadores"} title="Operadores" linkactive={false}>
						<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
				...
				<SidebarDropdown
					...
					<SidebarLink link={"orden_Servicio"} title="Orden de Servicio" linkactive={false}>
						<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
						</svg>
					</SidebarLink>
					<SidebarLink link={"asignar_Operador"} title="Asignar Operador" linkactive={false}>
						<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
				...
				<SidebarDropdown
					icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						...
						</svg>} title="Movimientos">
					<SidebarLink link={"mantenimientos"} title="Mantenimientos" linkactive={false}>
						<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
				...
				<SidebarDropdown
					...
					<SidebarLink link={"horometro"} title="Reporte horómetro" linkactive={false}>
						<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
						</svg>
					</SidebarLink>
					<SidebarLink link={"ganancias"} title="Ganancias vs Gastos" linkactive={false}>
						<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
