                                                                                ...
                                                                                <>
                                                                                                ...
                                                                                                <>
                                                                                                        ...
                                                                                                        <div className="flex flex-wrap -mx-3 mb-2">
                                                                                                                <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                                                                                                        ...
                                                                                                                        <input
                                                                                                                                className={`input-box ${formik.errors.nit && formik.touched.nit
                                                                                                                ...
                                                                                                                <div className="w-full md:w-1/3 px-3">
                                                                                                                        ...
                                                                                                                        <input
                                                                                                                                className={`input-box ${formik.errors.razonSocial &&
                                                                                        ...
                                                                                        <div className="flex flex-wrap -mx-3 mb-2">
                                                                                                <div className="w-full md:w-2/3 px-3 mb-6 md:mb-0">
                                                                                                        ...
                                                                                                        <input
                                                                                                                className={`input-box ${formik.errors.nombres && formik.touched.nombres
                                                                                                                                ? 'border border-red-500 '
                                                                                                                                : ''
                                                                                                                        }`}
                                                                                                                id="grid-name"
                                                                                                ...
                                                                                                <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                                                                                        ...
                                                                                                        <input
                                                                                                                className={`input-box ${formik.errors.cedula && formik.touched.cedula
                                                                                                                                ? 'border border-red-500 '
                                                                                                                                : ''
                                                                                                                        }`}
                                                                                                                id="grid-id"
                                                                                        ...
                                                                                        <div className="flex flex-wrap -mx-3 mb-2">
                                                                                                <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                                                                                        ...
                                                                                                        <input
                                                                                                                className={`input-box ${formik.errors.direccion &&
                                                                                                ...
                                                                                                <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                                                                                        ...
                                                                                                        <input
                                                                                                                className={`input-box ${formik.errors.email && formik.touched.email
                                                                                                                                ? 'border border-red-500 '
                                                                                                                                : ''
                                                                                                                        }`}
                                                                                                                id="grid-email"
                                                                                                ...
                                                                                                <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                                                                                        ...
                                                                                                        <input
                                                                                                                className={`input-box ${formik.errors.telefono && formik.touched.telefono
                                                                                                                                ? 'border border-red-500 '
                                                                                                                                : ''
                                                                                                                        }`}
                                                                                                                id="grid-phone"
